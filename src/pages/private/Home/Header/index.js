...
function Header({setIsNavMenuVisible, isNavMenuVisible, active, setActive}) {

    return (
        <>
            <div className="header" style={{backgroundColor:'#16379c'}}>
                <div className="header__inner clearfix">
                    ...
                    <Link to={'/dashboard'} className="account dropdown pull-right">
