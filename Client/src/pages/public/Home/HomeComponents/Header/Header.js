...
import ModalBrone from "../../../../../components/ModalBrone";
import SignIn from "../../../../../components/signinmodal";
import {Link} from "react-router-dom";
import logo from '../../../../../assets/logo/photo_2023-02-22_23-34-15.png'

function Header({active, setActive, setModalAuth, modalAuth, setIsNavMenuVisible, isNavMenuVisible}){
    return (
        <>
            ...
            {modalAuth && <SignIn modalAuth={modalAuth} setModalAuth={setModalAuth}/>}
        </>
    )
}
