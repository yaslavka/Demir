...
function KatalogSearch(){
    ...
    if (mobile) return(
        <>
            <div  className="search_form_scroll_target" style={{position: "relative", marginTop: 0, top: 0}}>
    ...
    return (
        <>
            {desktop && (
                <div className="main-search" style={{marginTop:-70, paddingLeft: 80, paddingRight: 80, paddingTop: -90,}}>
                                ...
                                <div className="main-search__controls nowrap">
                                    <div className="main-search__fields clearfix cc">
                                        <div
                                            ...
                                            <input name="search" value={search.search} placeholder="Локация / гостиница" onChange={handleOnchanges} className="main-search__destination-input main-search__input"/>
