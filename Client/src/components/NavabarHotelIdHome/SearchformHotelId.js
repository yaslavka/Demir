...
function SearchformHotelId({endDates, checked, handleChange, setEndtDates, setStarttDate, starttDate}){
    return (
        <>
                    ...
                    <Form>
                        ...
                        <div className="fieldset__wrapper">
                            <fieldset className="form__fieldset search-form-control-btns">
                                <Button color="primary" id="search-form-submit"
                                        className="search-form-submit ui  ui_red ui_filled ui_search_form"
