...
function NavbarPrivateUser({myobjekt}){
    ...
    const [ollbron, setOllbron] =useState(false)
    const [ollotzyv, setOllotzyv] =useState(false)
    ...
    return (
        <>
            <div className="dashboard-linksdown" >
                <Link className="dashboard-link" style={{justifyContent: "start"}} to={'/'}>
                    <svg
                        fill="#FFFFFF"
                        width={30}
                        viewBox="0 0 24 24" >
